    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          className={`resize-none rounded-card border bg-white/10 backdrop-blur-xl border border-white/20 px-3 py-2.5 text-sm text-text-primary placeholder:text-orange-300 focus:outline-none focus:ring-2 focus:ring-accent/50 ${
